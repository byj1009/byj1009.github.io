...
<img src="/image/hankook_05.png" alt=" " style="width:295px; height: 600px;"/>

2. ID 변경하기
[메뉴] > 검색에서 "ID 관리" > ID 변경하기   
앞서 변경한 비밀번호를 입력하고, 변경하고자 하는 아이디로 변경하면 이후부터 ID/PW를 통해 로그인이 가능하다.   

<img src="/image/hankook_02.png" alt=" " style="width:295px; height: 600px;"/>


<img src="/image/hankook_04.png" alt=" " style="width:295px; height: 600px;"/>
...
<img src="/image/hankook_03.v" alt=" " style="width:295px; height: 600px;"/>

<img src="/image/hankook_01.png" alt=" " style="width:295px; height: 600px;"/>


모의투자계좌 개설을 완료하면, [나의계좌]에서 생성이 완료된 모의계좌의 계좌번호를 조회할 수 있다. 한국투자증권 Open API를 신청할 때 해당 계좌가 필요하다.

<img src="/image/hankook_07.png" alt=" " style="width:1318px; height: 615px;"/>
...
<img src="/image/hankook_06.PNG" alt=" " style="width:1276px; height: 565px;"/>

<img src="/image/hankook_08.png" alt=" " style="width:1278px; height: 588px;"/>

<img src="/image/hankook_09.png" alt=" " style="width:1578px; height: 471px;"/>
